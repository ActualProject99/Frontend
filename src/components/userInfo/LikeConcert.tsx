    ...
    <div className="grid w-56 h-[26rem] group relative">
      ...
      <div className="flex flex-col justify-center items-center p-1 ">
        ...
        {concert.saleDone === "판매완료" ? (
          <p className="flex items-center justify-center absolute top-3 right-0 w-16 h-5 text-sm text-white font-bold rounded bg-slate-500 mr-3">
            {concert.saleDone}
          </p>
        ) : (
          <p className="flex items-center justify-center absolute top-3 right-1 w-16 h-5 text-sm text-white font-bold rounded bg-accent-main mr-2">
            {concert.saleDone}
          </p>
        )}
      </div>
